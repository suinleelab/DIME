...
if __name__ == '__main__':
    ...
    run_description = f"max_features_50_{pretrained_model_name}_lr_1e-5_use_entropy_sigmoid_with_token_individual_uniform_feature_cost_{mask_type}_mask_width_{mask_width}"
