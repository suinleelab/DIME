...
if __name__ == '__main__':
    ...
    trained_predictor_name = f"imagenet100_{pretrained_model_name}_predictor_lr_1e-3{mask_type}_mask_width_{mask_width}.pth"
    ...
    run_description = f"max_features_50_{pretrained_model_name}_lr_1e-3_use_entropy_sigmoid_with_token_individual_uniform_feature_cost_{mask_type}_mask_width_{mask_width}"
